...
class OAuth2OtpTokenGranter(
    ...
    override fun getOAuth2Authentication(client: ClientDetails, tokenRequest: TokenRequest): OAuth2Authentication {
        ...
        val password = parameters["otp"] as String

        var userAuth: Authentication = OtpAuthenticationToken(username, password)
